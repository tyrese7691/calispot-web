    ...
    <>
      ...
      <div className="wrap">
        ...
        <div className="body">
          ...
          <p>Photos you upload when suggesting a new spot or adding to an existing one, along
          with any location metadata you choose to attach. See Section 5 for how we use this content.</p>
          ...
          <table>
            ...
            <tbody>
              ...
              <tr><td>Submitted spot photos</td><td>Displaying spots in the app and on our channels</td><td>Contract / Legitimate interest</td></tr>
          ...
          <h2>5. Spot Photos &amp; Watermarking</h2>
          <p>
          ...
          <p>
            We may add a CaliSpot watermark, logo, or other branding to photos you submit
            before displaying or sharing them. This helps attribute content to the CaliSpot
            community and protects against unauthorised re-use elsewhere.
          </p>
          <p>
          ...
          <table>
            ...
            <tbody>
              ...
              <tr><td>Cloudflare R2</td><td>Image hosting (spot photos)</td><td>Submitted photos</td></tr>
          ...
          <ul>
            ...
            <li><strong>Submitted spot photos:</strong> May be retained after account deletion as they form part of the CaliSpot spot directory, unless you specifically request their removal.</li>
          </ul>
