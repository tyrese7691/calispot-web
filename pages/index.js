...
export default function SpotsGrid() {
  ...
  return (
    <div
      style={{
        background:
          "radial-gradient(1200px at top, #2a2a2a 0%, #121212 60%)",
        color: "#fff",
        minHeight: "100vh",
        padding: "1.5rem",
        fontFamily:
    ...
    >
      ...
      >
        ...
        <p style={{ lineHeight: "1.7", color: "#ccc", fontSize: "1.05rem" }}>
          ...
          with proper equipment, real photos, and an interactive map so you
          ...
          {[
            ...
            <div
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow = "0 30px 65px rgba(0,0,0,0.7)";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.transform = "translateY(0)";
      ...
      <div
        style={{
          ...
          borderRadius: "22px",
          textAlign: "center",
          background: "linear-gradient(135deg, #FFD500 0%, #FFC400 50%, #FFB300 100%)",
